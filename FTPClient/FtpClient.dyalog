:Class FtpPClient
⍝ Implement a simple, "Passive Mode" FTP Client
...
:endsection
    ...
    ∇ Make(host user pwd);r
      :Access Public
      :Implements Constructor
            ⍝ Assumes default-port 21.
      (⍕⊃r)⎕SIGNAL(0≠⊃r←Open host user pwd 21)/11
    ∇

    ∇ Make_port(host user pwd port);r
      :Access Public
      :Implements Constructor
      (⍕⊃r)⎕SIGNAL(0≠⊃r←Open host user pwd port)/11
    ∇

    ∇ r←Open args;r;p;a
      ⍝ Called by all constructors
     
      Host User PWD Port←args
      ...
      :AndIf 230=⊃r←Do'PASS ',PWD   ⍝ 230 User logged in
          r←0,1↓r
      :EndIf
      SetDF''
    ∇
